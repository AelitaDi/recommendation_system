...
class Film(models.Model):
    ...
    title = models.CharField(
        max_length=150, verbose_name="Название", help_text="Введите название фильма"
    )
    ...
    actors = models.ManyToManyField(
        "Actor", related_name="films", verbose_name="В фильме снимались"
    )
    genres = models.ManyToManyField("Genre", related_name="films", verbose_name="Жанр")
    release_year = models.IntegerField(
        validators=[MaxValueValidator(2025), MinValueValidator(1895)],
